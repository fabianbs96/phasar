...
#ifndef PHASAR_DATAFLOW_IFDSIDE_SOLVER_FLOWEDGEFUNCTIONCACHE_BASE_H
#define PHASAR_DATAFLOW_IFDSIDE_SOLVER_FLOWEDGEFUNCTIONCACHE_BASE_H
...
class FlowEdgeFunctionCacheBase : protected detail::FlowEdgeFunctionCachePerf {
protected:
...
public:
  ...
  [[nodiscard]] NonNullPtr<FlowFunctionType> getNormalFlowFunction(n_t Curr,
    ...
    return static_cast<Derived *>(this)->cacheNormalFlowFunction(Key, Curr,
                                                                 Succ);
  }
  ...
  [[nodiscard]] NonNullPtr<FlowFunctionType> getCallFlowFunction(n_t CallSite,
    ...
    return static_cast<Derived *>(this)->cacheCallFlowFunction(Key, CallSite,
                                                               DestFun);
  }
  ...
  getRetFlowFunction(n_t CallSite, f_t CalleeFun, n_t ExitInst, n_t RetSite) {
    ...
    return static_cast<Derived *>(this)->cacheRetFlowFunction(
        Key, CallSite, CalleeFun, ExitInst, RetSite);
  }
  ...
  getCallToRetFlowFunction(n_t CallSite, n_t RetSite,
    ...
    return static_cast<Derived *>(this)->cacheCallToRetFlowFunction(
        Key, CallSite, RetSite, Callees);
  }
  ...
  [[nodiscard]] EdgeFunctionType getNormalEdgeFunction(n_t Curr, d_t CurrNode,
    ...
    return static_cast<Derived *>(this)->cacheNormalEdgeFunction(
        OuterMapKey, Curr, CurrNode, Succ, SuccNode);
  }
  ...
  [[nodiscard]] EdgeFunctionType getCallEdgeFunction(n_t CallSite, d_t SrcNode,
    ...
    return static_cast<Derived *>(this)->cacheCallEdgeFunction(
        Key, CallSite, SrcNode, DestinationFunction, DestNode);
  }
  ...
  getReturnEdgeFunction(n_t CallSite, f_t CalleeFunction, n_t ExitInst,
    ...
    return static_cast<Derived *>(this)->cacheReturnEdgeFunction(
        Key, CallSite, CalleeFunction, ExitInst, ExitNode, RetSite, RetNode);
  }
  ...
  getCallToRetEdgeFunction(n_t CallSite, d_t CallNode, n_t RetSite,
    ...
    return static_cast<Derived *>(this)->cacheCallToRetEdgeFunction(
        OuterMapKey, CallSite, CallNode, RetSite, RetSiteNode, Callees);
  }
  ...
  [[nodiscard]] EdgeFunctionType getSummaryEdgeFunction(n_t CallSite,
    ...
    return static_cast<Derived *>(this)->cacheSummaryEdgeFunction(
        Key, CallSite, CallNode, RetSite, RetSiteNode);
  }
  ...
  template <typename Handler> void foreachCachedEdgeFunction(Handler Fn) const {
    static_cast<const Derived *>(this)->foreachCachedEdgeFunctionImpl(Fn);
  }
